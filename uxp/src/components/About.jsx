...
export const About = (props) => {
  return (
    <form method="dialog" className="aboutDialog">
      ...
      <sp-body>
        This is a simple plugin that demonstrates the various capabilities of
        React on UXP. When adapting to your own projects, you can replace{" "}
        <code>index.jsx</code> and the components with your own.
      </sp-body>
      <sp-body class="well">
        <sp-icon name="ui:InfoSmall" size="s"></sp-icon>
        We've also included the `WC` component and a couple of controllers. You
        do not need to use these in your own projects, but you are welcome to do
        so.
      </sp-body>

...
export type DepositNFTAndMintToken = ContractEventLog<{
  nftId: string;
  0: string;
}>;
export type BurnTokenAndWithdrawNFT = ContractEventLog<{
  nftId: string;
  0: string;
}>;
...
export interface WrappedNFTAbi extends BaseContract {
  ...
  clone(): WrappedNFTAbi;
  methods: {
    burnTokensAndWithdrawNfts(
      _nftIds: (number | string | BN)[],
      _destinationAddresses: string[]
    ...
    batchRemoveWithdrawnNFTsFromStorage(
      _numSlotsToCheck: number | string | BN
    ): NonPayableTransactionObject<void>;
  ...
  events: {
    ...
    DepositNFTAndMintToken(
      options?: EventOptions,
      cb?: Callback<DepositNFTAndMintToken>
    ): EventEmitter;

    BurnTokenAndWithdrawNFT(
      cb?: Callback<BurnTokenAndWithdrawNFT>
    ): EventEmitter;
    BurnTokenAndWithdrawNFT(
      options?: EventOptions,
      cb?: Callback<BurnTokenAndWithdrawNFT>

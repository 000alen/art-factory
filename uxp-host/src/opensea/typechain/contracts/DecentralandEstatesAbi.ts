...
export type CreateEstate = ContractEventLog<{
  _owner: string;
  _estateId: string;
  _data: string;
  0: string;
...
export type AddLand = ContractEventLog<{
  _estateId: string;
  _landId: string;
  0: string;
  1: string;
}>;
export type RemoveLand = ContractEventLog<{
  _estateId: string;
  _landId: string;
  _destinatary: string;
  0: string;
...
export type SetLANDRegistry = ContractEventLog<{
  _registry: string;
  0: string;
}>;

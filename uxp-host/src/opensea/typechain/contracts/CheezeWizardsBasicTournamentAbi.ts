...
export type DuelStart = ContractEventLog<{
  duelId: string;
  wizardId1: string;
  wizardId2: string;
  timeoutBlock: string;
...
export type DuelEnd = ContractEventLog<{
  duelId: string;
  wizardId1: string;
  wizardId2: string;
  moveSet1: string;
...
export type DuelTimeOut = ContractEventLog<{
  duelId: string;
  wizardId1: string;
  wizardId2: string;
  power1: string;
...
export type WizardElimination = ContractEventLog<{
  wizardId: string;
  0: string;
}>;
export type AscensionStart = ContractEventLog<{
  wizardId: string;
  0: string;
}>;
export type AscensionPairUp = ContractEventLog<{
  wizardId1: string;
  wizardId2: string;
  0: string;
  1: string;
}>;
export type AscensionComplete = ContractEventLog<{
  wizardId: string;
  power: string;
  0: string;
  1: string;
}>;
export type Revive = ContractEventLog<{
  wizId: string;
  power: string;
  0: string;
  1: string;
}>;
export type PowerGifted = ContractEventLog<{
  givingWizId: string;
...
export type PrizeClaimed = ContractEventLog<{
...
export type CEOTransferred = ContractEventLog<{
  previousCeo: string;
  newCeo: string;
  0: string;
  1: string;
}>;
export type COOTransferred = ContractEventLog<{
  previousCoo: string;
  newCoo: string;
  0: string;
  1: string;
}>;
export type CFOTransferred = ContractEventLog<{
  previousCfo: string;
  newCfo: string;
  0: string;
  1: string;
...
export interface CheezeWizardsBasicTournamentAbi extends BaseContract {
  ...
  methods: {
    ...
    pause(
      pauseDuration: number | string | BN
    ...
    enterWizards(
      wizardIds: (number | string | BN)[],
      powers: (number | string | BN)[]
    ...
    oneSidedCommit(
      committingWizardId: number | string | BN,
      otherWizardId: number | string | BN,
      commitment: string | number[]
    ): NonPayableTransactionObject<void>;
    ...
    doubleCommit(
      wizardId1: number | string | BN,
      wizardId2: number | string | BN,
      commit1: string | number[],
      commit2: string | number[],
      sig1: string | number[],
      sig2: string | number[]
    ): NonPayableTransactionObject<string>;
    ...
    oneSidedReveal(
      ...
      moveSet: string | number[],
      salt: string | number[],
      otherWizardId: number | string | BN,
      otherCommit: string | number[]
    ): NonPayableTransactionObject<void>;
    ...
    doubleReveal(
      ...
      commit1: string | number[],
      commit2: string | number[],
      moveSet1: string | number[],
      moveSet2: string | number[],
      salt1: string | number[],
      salt2: string | number[]
    ): NonPayableTransactionObject<void>;
    ...
    giftPower(
      sendingWizardId: number | string | BN,
      receivingWizardId: number | string | BN
    ): NonPayableTransactionObject<void>;

    cullMoldedWithSurvivor(
      wizardIds: (number | string | BN)[],
      survivor: number | string | BN
    ): NonPayableTransactionObject<void>;

    cullMoldedWithMolded(
      moldyWizardIds: (number | string | BN)[]
    ): NonPayableTransactionObject<void>;
    ...
    claimTheBigCheeze(
      claimingWinnerId: number | string | BN
    ): NonPayableTransactionObject<void>;

    claimSharedWinnings(
      claimingWinnerId: number | string | BN,
      allWinners: (number | string | BN)[]
    ): NonPayableTransactionObject<void>;

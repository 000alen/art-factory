...
export type TokenPurchase = ContractEventLog<{
  buyer: string;
  eth_sold: string;
...
export type EthPurchase = ContractEventLog<{
  buyer: string;
  tokens_sold: string;
  eth_bought: string;
  0: string;
...
export interface UniswapExchangeAbi extends BaseContract {
  ...
  methods: {
    ...
    addLiquidity(
      min_liquidity: number | string | BN,
      max_tokens: number | string | BN,
      deadline: number | string | BN
    ): PayableTransactionObject<string>;

    removeLiquidity(
      amount: number | string | BN,
      min_eth: number | string | BN,
      min_tokens: number | string | BN,
      deadline: number | string | BN
    ...
    ethToTokenSwapOutput(
      tokens_bought: number | string | BN,
      deadline: number | string | BN
    ): PayableTransactionObject<string>;
    ...
    tokenToTokenSwapInput(
      tokens_sold: number | string | BN,
      min_tokens_bought: number | string | BN,
      min_eth_bought: number | string | BN,
      deadline: number | string | BN,
      token_addr: string
    ): NonPayableTransactionObject<string>;
    ...
    tokenToTokenSwapOutput(
      tokens_bought: number | string | BN,
      max_tokens_sold: number | string | BN,
      max_eth_sold: number | string | BN,
      deadline: number | string | BN,
      token_addr: string
    ): NonPayableTransactionObject<string>;
  ...
  events: {
    ...
    TokenPurchase(
      ...
      cb?: Callback<TokenPurchase>
    ): EventEmitter;

    EthPurchase(cb?: Callback<EthPurchase>): EventEmitter;
    EthPurchase(
      options?: EventOptions,
      cb?: Callback<EthPurchase>
    ): EventEmitter;

...
import {
    BaseContract, BlockType, Callback, ContractEventLog, NonPayableTransactionObject,
...
export type Retire = ContractEventLog<{
  _block: string;
...
export type UpdateDecimals = ContractEventLog<{
  _id: string;
  0: string;
}>;
export type UpdateName = ContractEventLog<{
  _id: string;
  0: string;
}>;
export type UpdateSymbol = ContractEventLog<{
  _id: string;
  0: string;
}>;
...
export type Assign = ContractEventLog<{
  _id: string;
  _from: string;
  _to: string;
  0: string;
...
export type AcceptAssignment = ContractEventLog<{
  _id: string;
  _creator: string;
  0: string;
  1: string;
}>;
export type Create = ContractEventLog<{
  _id: string;
  _creator: string;
...
export type UpdateMaxMeltFee = ContractEventLog<{
  _id: string;
  0: string;
}>;
export type UpdateMeltFee = ContractEventLog<{
  _id: string;
  0: string;
}>;
export type OperatorApproval = ContractEventLog<{
  _owner: string;
  _operator: string;
  _id: string;
  _approved: boolean;
...
export type TransferFee = ContractEventLog<{
  _id: string;
  _sender: string;
  _feeId: string;
  _feeValue: string;
...
export type UpdateMaxTransferFee = ContractEventLog<{
  _id: string;
  0: string;
}>;
export type UpdateTransferable = ContractEventLog<{
  _id: string;
  0: string;
}>;
export type UpdateTransferFee = ContractEventLog<{
  _id: string;
  0: string;
}>;
export type Whitelist = ContractEventLog<{
  _id: string;
  _account: string;
  _whitelisted: string;
  _on: boolean;
...
export type Melt = ContractEventLog<{
  _id: string;
  _owner: string;
  _value: string;
  0: string;
...
export type DeployERCAdapter = ContractEventLog<{
  _id: string;
  _sender: string;
  0: string;
  1: string;
}>;
export type CreateTrade = ContractEventLog<{
  _tradeId: string;
  _firstParty: string;
  _secondParty: string;
...
export type CompleteTrade = ContractEventLog<{
  _tradeId: string;
  _firstParty: string;
  _secondParty: string;
...
export type CancelTrade = ContractEventLog<{
  _tradeId: string;
  _firstParty: string;
  _receivedEnjFirstParty: string;
  0: string;
...
export interface ERC1155Abi extends BaseContract {
  ...
  methods: {
    ...
    create(
      ...
      _initialReserve: number | string | BN,
      _supplyModel: string,
      _meltValue: number | string | BN,
      _meltFeeRatio: number | string | BN,
      _transferable: number | string | BN,
      _transferFeeSettings: (number | string | BN)[],
    ...
    approve(
      _spender: string,
      _id: number | string | BN,
      _currentValue: number | string | BN,
      _value: number | string | BN
    ): NonPayableTransactionObject<void>;
    ...
    batchApprove(
      _spender: string,
      _ids: (number | string | BN)[],
      _currentValues: (number | string | BN)[],
      _values: (number | string | BN)[]
    ): NonPayableTransactionObject<void>;
    ...
    createTrade(
      _askingIds: (number | string | BN)[],
      _askingValues: (number | string | BN)[],
      _offeringIds: (number | string | BN)[],
      _offeringValues: (number | string | BN)[],
      _secondParty: string
    ): NonPayableTransactionObject<void>;
  ...
  events: {
    ...
    CompleteTrade(
      options?: EventOptions,
      cb?: Callback<CompleteTrade>
    ): EventEmitter;

    CancelTrade(cb?: Callback<CancelTrade>): EventEmitter;
    CancelTrade(
      options?: EventOptions,
      cb?: Callback<CancelTrade>
    ): EventEmitter;

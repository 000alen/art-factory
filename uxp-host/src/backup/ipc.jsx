...
//       window.ipcRenderer.once(`${task}Result`, (result) => resolve(result));
...
//   return new Promise((resolve, reject) => {
//     window.ipcRenderer.once("factoryLoadSecretsResult", (result) =>
//       resolve(result)
//     );

//     window.ipcRenderer.send("factoryLoadSecrets", id, secrets);
//   });
// };
